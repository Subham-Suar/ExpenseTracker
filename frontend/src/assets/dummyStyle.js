...
export const expensePageStyles = {
  ...
  emptyStateSubtextAlt: "text-sm text-gray-500 mt-2",
...
export const sidebarStyles = {
  ...
  userAvatar: {
    base: "w-10 h-10 rounded-full bg-gradient-to-br from-cyan-400 to-teal-500 flex items-center justify-center text-white font-bold text-lg mb-2",
  ...
  logoutButtonCompact: {
    base: "flex items-center gap-2 py-2 px-3 rounded-lg font-medium text-gray-600 hover:text-red-600 hover:bg-red-50 w-full",
    icon: "text-lg",
    text: "text-sm"
  }
};
